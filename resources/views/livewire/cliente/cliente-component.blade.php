        ...
        <div class="containergit">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type="button" class="btn btn-info" wire:click="nuevo()" data-toggle="modal" data-target="#exampleModal">
                                ...
                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="mb-4 d-flex flex-wrap">
                                        ...
                                        <div class="col-5 m-2">
                                            ...
                                            <select name="provincia_id" id="" wire:model="provincia_id" style="width: inherit;">
                                                <option value="" selected>-</option>
                                                    ...
                                                    <div class="col-12 m-2">
                                                        <div class="row row-cols-1 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 row-cols-xxl-6 g-4 pl-2 py-5 justify-content-center"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="card ml-2" wire:click="DevolverCuotas(1)">
