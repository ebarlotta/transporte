        ...
        <div class="containergit">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#ModalNuevaLocalidad">
                        Nuevo
                    </button>
            ...
            <div wire:ignore.self class="modal fade" id="ModalNuevaLocalidad" tabindex="-1"
