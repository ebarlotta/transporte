                            ...
                            @foreach ($destinos as $destino)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        {{-- <?php 
                                            // $destino->nombre =str_replace(' ', '', $destino->nombre);
                                        ?>
                                        <style>#gmp-map{{ $destino->nombre }} { height: 100%; }</style>
                                        
                                        <script>
                                            function initMap() {
                                            const myLatLng{{ $destino->nombre }} = { lat: <?php echo rand(-90,90);?>, lng: <?php echo rand(-180,180);?> };
                                            const map{{ $destino->nombre }} = new google.maps.Map(document.getElementById(<?php echo '"gmp-map'.$destino->nombre.'"'; ?>), { zoom: 14, center: myLatLng{{ $destino->nombre }},fullscreenControl: false, zoomControl: true, streetViewControl: false });
                                            }
                                        </script>
                                        <div style="width: 251px; height: 86px;">
                                            <div id="gmp-map{{ $destino->nombre }}"></div>
                                        </div>
                                        {{ $destino->ubicaciongps }} --}}
                                    </td>
                                    ...
                                    <td class="align-middle">{{ $destino->fotourl }}</td>
                                    <td class="align-middle">
